...
def get_geotiff_subset(dataset, zoom, x, y):
    ...
    ds_subset = gdal.Translate('/vsimem/' + str(zoom) + '_' + str(x) + '_' + str(y) + '.tif', dataset, projWin=projwin)
    # ds = gdal.Open('/vsimem/' + str(zoom) + '_' + str(x) + '_' + str(y) + '.tif')
    return ds_subset

    gdal.Translate(str(zoom) + '_' + str(x) + '_' + str(y) + '.tif', dataset, projWin=projwin)
