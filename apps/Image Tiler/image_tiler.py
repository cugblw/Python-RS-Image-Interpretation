...
from utils.save_tile import generate_low_zoom_tar, save_tile
# from utils.watermark import generate_watermark_by_text
    ...
    for key in tile_range:
        ...
        for x in range(x_min, x_max+1):
            for y in range(y_min, y_max+1):
                ...
                # # add watermark
                # if img is not None:
                #     img = generate_watermark_by_text(img)
...
if __name__ == "__main__":
    ...
    geotiff_path = "E:/Data/test/lanzhou_2m_test.tif"
    ...
    # # 创建瓦片压缩包
    # generate_low_zoom_tar(tile_dir, tile_dir, zoom_divide, start_zoom, "png")
